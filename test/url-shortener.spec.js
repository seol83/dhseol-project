...
var testData = [
  { oUrl:"http://www.daum.net", sUrl:"1M8ocib"},
  { oUrl:"https://hyunseob.github.io/2016/05/09/assert-nodejs-test-module/", sUrl:"ZBNQt5Qj"},
...
describe("url-shortener.getOriginUrl test", function(){
  ...
  it("getOriginUrl test-03 url not registered", function(){
    assert.equal(urlShortener.getOriginUrl('zzzzzz'), 'ERROR_NOT_REGISTERED');
  });
});
